...
public class BuyTehPucuk extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buytehpucuk);
        ...
        tehpucuk = (ImageView)findViewById(R.id.tehpucuk);
        ...
        btn.setOnClickListener(new ElegantNumberButton.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("counttehpucuk", num);
                editor.apply();
                finish();
            }
        });
